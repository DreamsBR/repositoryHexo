...
public class EmpresaController {
    ...
    @PostMapping
    public ResponseEntity<EmpresaDTO> registrar(@RequestBody RequestEmpresa request){
        return ResponseEntity
                .status(HttpStatus.CREATED)
                .body(empresaserviceIn.saveEmpresa(request));
    }
    ...
    public ResponseEntity<EmpresaDTO>obtenerPersona(@PathVariable Long id){
        return ResponseEntity
                ...
                .body(empresaserviceIn.obtenerPersonaOut(id).get());
    ...
    @PutMapping("/{id}")
    public ResponseEntity<EmpresaDTO>actualizar(@PathVariable Long id,@RequestBody RequestEmpresa request){
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(empresaserviceIn.updateEmpresa(id,request));
